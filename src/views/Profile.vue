      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div class="space-y-3">
              ...
              <div class="flex justify-between">
                ...
                <span class="text-gray-900">{{ orders.length }}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Total spent</span>
                <span class="text-gray-900">${{ totalSpent }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3">
              <router-link to="/products" class="block w-full btn-outline text-center">
                Browse Products
              </router-link>
              <router-link to="/cart" class="block w-full btn-primary text-center">
                View Cart
              </router-link>
              <button @click="logout" class="block w-full btn-outline text-center border-red-300 text-red-600 hover:bg-red-50">
                Sign Out
              </button>
            </div>
          </div>
