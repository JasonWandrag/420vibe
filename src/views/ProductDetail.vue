<template>
  <div class="min-h-screen bg-gray-50 py-6 sm:py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Product Not Found -->
      <div v-else-if="!product" class="text-center py-8 sm:py-12">
        <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Product Not Found</h2>
        <p class="text-gray-600 mb-4 sm:mb-6">The product you're looking for doesn't exist.</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 p-4 sm:p-6 lg:p-8">
          ...
          <div class="space-y-4 sm:space-y-6">
            <div>
              <div class="flex items-center justify-between mb-2">
                ...
                <div class="flex items-center space-x-1">
                  ...
                  <span class="text-xs sm:text-sm text-gray-500">({{ product.reviews }} reviews)</span>
                </div>
              </div>
              <h1 class="text-2xl sm:text-3xl font-display font-bold text-gray-900 mb-3 sm:mb-4">
                {{ product.name }}
              </h1>
              <p class="text-xl sm:text-2xl font-bold text-primary-600 mb-3 sm:mb-4">
                R{{ product.price }}
              </p>
            ...
            <div class="border-t pt-4 sm:pt-6">
              <h3 class="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Product Details</h3>
            ...
            <div class="border-t pt-4 sm:pt-6">
              ...
              <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button 
                  @click="addToCart"
                  class="btn-primary flex-1 text-base sm:text-lg py-3"
                >
                  Add to Cart - R{{ (product.price * quantity).toFixed(2) }}
                </button>
                <button class="btn-outline px-4 sm:px-6 py-3 flex items-center justify-center">
            ...
            <!-- Reviews Section -->
            <div class="border-t pt-4 sm:pt-6">
              <h3 class="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Customer Reviews</h3>
              <div class="space-y-3 sm:space-y-4">
                <div 
                  v-for="review in product.reviewList" 
                  :key="review.id"
                  class="border-l-4 border-primary-200 pl-3 sm:pl-4"
                >
                  <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-1 sm:gap-0">
                    <span class="font-medium text-gray-900 text-sm sm:text-base">{{ review.author }}</span>
                    <div class="flex items-center space-x-1">
                      <span class="text-xs sm:text-sm text-gray-500">⭐ {{ review.rating }}</span>
