  ...
  <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <div class="flex justify-center">
        <img src="/src/assets/images/Logo_Clear.png" alt="420Vibe" class="h-10 sm:h-12 w-auto" />
      </div>
      <h2 class="mt-4 sm:mt-6 text-center text-2xl sm:text-3xl font-display font-bold text-gray-900">
        ...
        <form class="space-y-6" @submit.prevent="handleLogin">
          ...
          <div>
            <button
              ...
              class="w-full btn-primary py-3 text-base sm:text-lg"
            >
